...
technique_names=("gnnexplainer")  # Replace with your actual technique names "cf-gnnfeatures" "cf-gnn"  "random-feat" "random" "ego" "cff" "combined" "unr"  "cff" "combined"
dataset=( "proteins_g") # "aids_g" "enzymes_g" "coil"
