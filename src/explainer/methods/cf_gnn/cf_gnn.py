...
from ....utils.utils import ExplanationContext, build_counterfactual_graph_gc, get_optimizer
...
class CFExplainer(ExplainerABC):
    ...
    def train(self, graph: Data, oracle: nn.Module) -> Data:
        ...
        y_non_differentiable = torch.argmax(output_actual, dim=1)
        ...
        context = ExplanationContext(y_pred_new_actual=y_non_differentiable,
